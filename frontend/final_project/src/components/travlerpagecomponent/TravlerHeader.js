...
const TravlerHeader = () => {
  ...
  console.log('flightConfirm입니다. : ', flightConfirm);
  // console.log('TravlerHeader의 flightConfirm : ', flightConfirm);
  const firstInfo = useSelector((state) => {
    return state.searchReducer;
  });
  console.log('firstInfo입니다. : ', firstInfo);
      ...
      >
        <ThemeProvider theme={theme}>
          ...
          <Box sx={{ display: 'flex', marginTop: 3 }}>
            <Typography variant='myStyle'>성인 {firstInfo.adults}명</Typography>
            ...
            {firstInfo.returnDate === null ? (
              <Typography variant='myStyle'>&nbsp;● 편도 ●&nbsp;</Typography>
            ) : (
              <Typography variant='myStyle'>&nbsp;● 왕복 ●&nbsp;</Typography>
            )}
