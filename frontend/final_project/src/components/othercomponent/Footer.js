            ...
            <ul className='footer-list'>
              <li>
                <Link
                  underline='hover'
                  color='inherit'
                  href='https://github.com/Shon-Sang'
                  target='_blank'
                  fontSize='small'
                >
                  손상기
                ...
                <Link
                  underline='hover'
                  color='inherit'
                  href='https://github.com/nicolaslee2000'
                  target='_blank'
                  fontSize='small'
                >
                  이건영
